...
<ul>
    <li>update on verifying time protection (systematic prevention of microarchitectural timing channels)</li>
    <li>the Pancake language for verifying device drivers</li>
    <li>provably secure general-purpose OS</li>
    <li>improvements to the MCS kernel API</li>
</ul>
<p>
