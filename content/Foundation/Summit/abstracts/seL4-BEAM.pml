<div class="summit-abstract">
    ...
    <p>
        When building secure and robust systems, the general strategy is to "prevent, contain, and recover". Ideally we <strong>prevent</strong> problems (like errors and vulnerabilities) from occurring in the first place, <strong>contain</strong> the effects of any problems that do occur, and *recover* from those problems by repairing any damage and ensuring the problems do not happen again in the future.
    </p>
    <p>
